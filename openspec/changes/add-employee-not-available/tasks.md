...
- [ ] 3.2 Actualizar `employees.component.html`
...
- [ ] 5.1 Actualizar `company-list.component.ts`
  - Filtrar empleados con `not_available = true` antes de mostrarlos
- [ ] 5.2 Verificar que el filtrado funciona correctamente

## Phase 6: Tests
- [ ] 6.1 Actualizar tests de `UserService` para incluir `not_available`
- [ ] 6.2 Agregar tests para `toggleNotAvailable`
- [ ] 6.3 Actualizar tests de `employees.component` para verificar toggle de no disponible
- [ ] 6.4 Agregar tests para filtrado en `company-list.component`
- [ ] 6.5 Verificar que todos los tests pasan (`npm test`)
...
- [ ] 7.2 Actualizar documentación si es necesario
- [ ] 7.3 Commit y push de todos los cambios
