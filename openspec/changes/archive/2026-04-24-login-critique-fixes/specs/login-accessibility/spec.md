...
### Requirement: Decorative Background Excess
**Reason**: Fase 2 visual cleanup — reduce cognitive noise and improve performance
**Migration**: Remover 2 blobs, 2 deco-shapes, y grid pattern. Mantener fondo limpio con color sólido o 1 blob máximo.

### Requirement: Generic Social Proof
**Reason**: Avatares con iniciales inventadas ("MG", "CS", "AR") generan desconfianza en lugar de trust
**Migration**: Remover el bloque de avatares y texto "+500 profesionales" del login. Mantener solo si hay datos reales con fotos.
